...
def configure_matplotlib_fonts():
    ...
    # 尝试使用系统字体
    try:
        plt.rcParams['font.sans-serif'] = [font_name, 'SimHei', 'Arial Unicode MS', 'sans-serif']
...
def set_application_style(app):
    """设置应用全局样式"""
    # 设置全局字体
    font = QFont("Microsoft YaHei", 10) if sys.platform.startswith('win') else QFont("PingFang SC", 10)
    app.setFont(font)
