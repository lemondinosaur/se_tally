...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QFormLayout,
                           ...
                           QPushButton, QMessageBox, QDoubleSpinBox, QGroupBox,
                           QFrame)
...
class AddRecordPage(QWidget):
    ...
    def update_preview(self):
        """更新预览标签"""
        record_type = RecordType.INCOME if self.type_combo.currentIndex() == 0 else RecordType.EXPENSE
    ...
    def on_save(self):
        ...
        record_type = RecordType.INCOME if type_str == RecordType.INCOME.value else RecordType.EXPENSE
        ...
        try:
            if self.current_record_id is not None:
                ...
                success = self.record_manager.update_record(
                    self.current_record_id, amount, category, description, record_type, date_time
                )
                if success:
